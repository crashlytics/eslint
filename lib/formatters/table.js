 /* 
  * Disabling this formatter due to its reliance on table library
  * which has a transitive dependency on jsonify (that has invalid
  * license). Will throw an error when this formatter is being used.
  */
...
module.exports = function() {
    throw "This formatter has been disabled";
}
